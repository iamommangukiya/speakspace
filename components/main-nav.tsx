            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "text-blue-600 bg-blue-50 text-blue-600 bg-blue-50"
                    : "text-slate-700 hover:text-blue-600 hover:bg-blue-50/50 dark:text-slate-300 hover:text-blue-600 hover:bg-blue-50/50",
                )}
              >
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-slate-700 hover:text-blue-600 text-slate-700 hover:text-blue-600",
              )}
            >
